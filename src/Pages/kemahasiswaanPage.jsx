    ...
    return (
        <div className="w-full flex flex-col">
            ...
            <div className="md:w-full h-[90vh] md:h-[90vh] mt-[29%] md:mt-[10%] lg:mt-[6%] 2xl:mt-[7%] flex flex-col lg:flex-row py-6 gap-2">
                <NavbarLeft />
                <div className="flex flex-col md:flex-col lg:flex-row w-full overflow-y-scroll h-[84vh] md:overflow-x-hidden">
                    ...
                    <div className="md:flex-col px-5 py-3 mt-40 md:mt-2 lg:mt-4 lg:px-1">
