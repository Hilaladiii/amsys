...
const DashboardPage = () => {  
  ...
  return (
    <div className={`w-full bg-[url('./assets/images/BackgroundDashboard.svg')] bg-no-repeat bg-cover`}>      
      ...
      <div className="w-full flex flex-col mx-auto mt-[40%] md:mt-[12%] lg:mt-[9%] justify-center items-center">
        <h1 className="text-[15px] md:text-[30px] lg:text-[38px] 2xl:text-[42px] font-bold text-tBlue animate-fade animate-delay-200">Academic Monitoring System</h1>
        <p className=" w-[55%] md:w-[50%] lg:w-[40%] text-[12px] md:text-[15px] 2xl:text-[18px] font-medium animate-fade animate-delay-300">Dapatkan akses real-time untuk memantau nilai, kehadiran dan tugas anak Anda secara terperinci.</p>
      </div>
