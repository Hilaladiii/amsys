  ...
  return (
    <div className={`w-full h-screen bg-[url('./assets/images/BackgroundDashboard.svg')] bg-no-repeat bg-cover flex flex-col`}>      
      ...
      <div className="w-full flex flex-row px-36 mt-20 animate-fade-right">
        <CardMain title={'Kemahasiswaan'} content={["Hubungi Dosen Pembimbing Akademik","Kartu Hasil Studi dan Evaluasi"]}/>
        <CardMain title={'Akademik'} content={["Statistik IPK","Jadwal Kuliah","KHS Evaluasi","Kehadiran"]}/>
        <CardMain title={'Informasi'} content={["Akademik","Kalender Akademik","Biaya","Terkini"]}/>
      </div>
    </div>
  )
}
