  ...
  return (
    <div className={`w-full h-screen bg-[url('./assets/images/BackgroundDashboard.svg')] bg-no-repeat bg-cover`}>      
      ...
      <div className="w-full flex flex-col md:flex-row justify-between items-center px-36 mt-20  animate-fade-right">
        <CardMain title={'Kemahasiswaan'} icons="kemahasiswaan.png" content={["Hubungi Dosen Pembimbing Akademik","Kartu Hasil Studi dan Evaluasi"]}/>
        <CardMain title={'Akademik'} icons="akademik.png" content={["Statistik IPK","Jadwal Kuliah","KHS Evaluasi","Kehadiran"]}/>
        <CardMain title={'Informasi'} icons="informasi.png" content={["Akademik","Kalender Akademik","Biaya","Terkini"]}/>
      </div>
