...
const CardKemahasiswaan = ({title, logo, description, salary,color}) => {
    return (
        <div className="w-full lg:w-[600px] h-[130px] shadow-md rounded-lg pr-6 duration-300 animate-fade-down animate-delay-300 relative">
                    ...
                    <div className="w-[45vw] flex flex-row justify-between">
                        <div className="flex flex-col items-start px-5 py-4 group-hover:text-white">
                            <div className="flex flex-row items-center"> 
                                ...
                                <h1 className="text-[11px] md:text-[15px] px-4 font-semibold border md:px-2 rounded-full" style={{background: `rgba(${color})`, color: "#00000"}} >{title}</h1>
                            </div>
                        </div>
