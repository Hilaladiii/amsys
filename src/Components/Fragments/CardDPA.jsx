...
const CardDPA = () => {
  return (
      <div className="w-full flex flex-col justify-center items-center gap-3 p-8 bg-white rounded-3xl shadow-2xl duration-300 animate-fade-down animated-delay-300">
