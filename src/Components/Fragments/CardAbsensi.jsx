...
const CardAbsensi = () => {
  return (
    <div className="w-[450px] flex flex-col justify-between  p-10 rounded-md shadow-md ">
          ...
          <select name="mata_kuliah" id="" className="w-[35%] bg-tBlue text-white rounded-md px-3">
            ...
            <option value="imk">BASIS DATA</option>          
          </select>
          <span className="mx-auto text-[42px] font-semibold">91%</span>
